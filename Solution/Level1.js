...
function init(){
	...
	// TV light
	tvSpotlight.position.set(-15.6,0.7,-2.6);
	...
	// TV light
	tvPointlight.position.set(-15.0,2.0,-3.1);
	...
	loader.load('../Assets/15Room in the Woods.glb', function(gltf){
	...
	eyeX = [4.35, 4.07, 0.0, -8.86, -2.77];
	eyeY = [1.70, 2.76, 5.63, 1.50, 4.30];
	eyeZ = [0.38, -3.20, 0.06, 1.15, 4.11];
	...
	// Load entity enemy
	teleportX = [0, 4.6, -4.5, 0.75, 0.75];
	teleportY = [-10, 1.55, 3.5, 3.5, 3.5];
	teleportZ = [0, -0.1, 0.75, 4.5, -4.5 ];	
...
function animate(){
	...
	if(isWatching){
		...
		if(!wasWatching){
			teleportNum = randomIntFromInterval(1,4);
		}
